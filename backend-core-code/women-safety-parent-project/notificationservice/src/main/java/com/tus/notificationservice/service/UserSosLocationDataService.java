...
public class UserSosLocationDataService {
    ...
    public void deleteSosNotificationBySosId(long sos_id) {
        List<UserSosLocationData> userSosLocationDataList = userSosLocationDataRepo.getSosNotificationBySosId(sos_id);
        userSosLocationDataRepo.deleteAll(userSosLocationDataList);
    }
}
